...
def preprocess_video(video, interval, savepath, water_info):
    ...
    for f in frame_array:
        ...
        if success == False:
            ...
            update_json(savepath + "/" + videoname +'_' + str(cnt), videoname +'_' + str(cnt), water_info, h, w, videonamemp4, video_time, f)
...
def preprocess_img(image, savepath, water_info):
    ...
    update_json(savepath + "/" + imagename, imagename, water_info, h, w, imagenamejpg, None, None)
